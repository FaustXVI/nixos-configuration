...
let
  settings = {
    ...
    format = ''''${custom.eo-vent-tools}''${custom.watson}$all'';
    right_format = "";
    ...
    "custom.watson" = {
      ...
      when = ''watson status -p | grep -v "No project started"'';
      symbol = " ";
    };

    "custom.eo-vent-tools" = {
      command = "eo-vent-tools --version";
      when = "eo-vent-tools --version";
      symbol = " ";
      disabled = true;
    };
  };
